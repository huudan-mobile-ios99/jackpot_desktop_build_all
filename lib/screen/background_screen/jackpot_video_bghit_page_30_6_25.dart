...
//   @override
//   _JackpotBackgroundVideoHitWindowFadeAnimationPState createState() =>
//       _JackpotBackgroundVideoHitWindowFadeAnimationPState();
// }

// class _JackpotBackgroundVideoHitWindowFadeAnimationPState
//     extends State<JackpotBackgroundVideoHitWindowFadeAnimationP> {
//   late final Player _player;
//   late final VideoController _controller;
//   final NumberFormat _numberFormat = NumberFormat('#,##0.00', 'en_US');
//   String? _currentVideoPath;
//   bool _isSwitching = false;
//   bool _isVideoReady = false; // Track if video is ready
...
//     // Listen to video state to determine when it's ready
//     _controller.stream.width.listen((width) {
//       if (mounted && width != null && width > 0) {
//         setState(() {
//           _isVideoReady = true; // Video is ready when width is available
//         });
//       }
//     });
...
//       setState(() {
//         _isVideoReady = false; // Reset video readiness when ID changes
//       });
//       _loadVideo(getVideoAssetPath(widget.id));
//     }
//   }
...
//           ),
//           // Show text only if video is ready
//           if (_isVideoReady)
//             ...[
//               Positioned(
