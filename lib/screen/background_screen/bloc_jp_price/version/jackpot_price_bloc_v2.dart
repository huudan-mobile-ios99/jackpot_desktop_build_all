...
// import 'jackpot_state_state.dart';
...
//         (message) async {
//           try {
//             debugPrint('JackpotPriceBloc: [Endpoint $index] ${DateTime.now().toIso8601String()}: $message');
...
//       // // Save to Hive only if batch contains all 9 valid keys and is different from last saved batch
...
//       //       debugPrint('JackpotPriceBloc: Saved batch to Hive: $batchToSave');
...
//       //     }
//       //   } else {
//       //     debugPrint('JackpotPriceBloc: Skipped saving batch, incomplete or duplicate: $batchToSave');
//       //   }
//       // }
//     }
//   }
