  ...
  Widget build(BuildContext context) {
    ...
    Column(
      children: [
        ...
        Text('${widget.hiveValue.toStringAsFixed(2)} | ${widget.startValue.toStringAsFixed(2)}->${widget.endValue.toStringAsFixed(2)}',style:const TextStyle(color:Colors.white))
        ],
    );
  }
